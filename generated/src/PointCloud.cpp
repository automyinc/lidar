...
void PointCloud::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = automy::lidar::vnx_native_type_code_PointCloud;
...
void PointCloud::write(std::ostream& _out) const {
	_out << "{\"__type\": \"automy.lidar.PointCloud\"";
...
vnx::Object PointCloud::to_object() const {
	vnx::Object _object;
	_object["__type"] = "automy.lidar.PointCloud";
	_object["time"] = time;
	_object["frame"] = frame;
...
std::shared_ptr<vnx::TypeCode> PointCloud::static_create_type_code() {
	...
	type_code->native_size = sizeof(::automy::lidar::PointCloud);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<PointCloud>(); };
	type_code->depends.resize(1);
	type_code->depends[0] = ::automy::lidar::point_t::static_get_type_code();
...
void write(TypeOutput& out, const ::automy::lidar::PointCloud& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = automy::lidar::vnx_native_type_code_PointCloud;
